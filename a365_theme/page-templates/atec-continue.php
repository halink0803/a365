...
$result = load_data_for_atec_continue($_SESSION['atec_result_id']);
$answers = array();
$index = 1;
$i = 1;
...
$answers[$i++] = $result->answer_29;
$answers[$i++] = $result->answer_30;
$answers[$i++] = $result->answer_31;
$answers[$i++] = $result->answer_32;
$answers[$i++] = $result->answer_33;
$answers[$i++] = $result->answer_34;
$answers[$i++] = $result->answer_35;
$answers[$i++] = $result->answer_36;
$answers[$i++] = $result->answer_37;
$answers[$i++] = $result->answer_38;
$answers[$i++] = $result->answer_39;
$answers[$i++] = $result->answer_40;
$answers[$i++] = $result->answer_41;
$answers[$i++] = $result->answer_42;
$answers[$i++] = $result->answer_43;
$answers[$i++] = $result->answer_44;
$answers[$i++] = $result->answer_45;
$answers[$i++] = $result->answer_46;
$answers[$i++] = $result->answer_47;
$answers[$i++] = $result->answer_48;
$answers[$i++] = $result->answer_49;
$answers[$i++] = $result->answer_50;
$answers[$i++] = $result->answer_51;
$answers[$i++] = $result->answer_52;
$answers[$i++] = $result->answer_53;
$answers[$i++] = $result->answer_54;
$answers[$i++] = $result->answer_55;
$answers[$i++] = $result->answer_56;
$answers[$i++] = $result->answer_57;
$answers[$i++] = $result->answer_58;
$answers[$i++] = $result->answer_59;
$answers[$i++] = $result->answer_60;
$answers[$i++] = $result->answer_61;
$answers[$i++] = $result->answer_62;
$answers[$i++] = $result->answer_63;
$answers[$i++] = $result->answer_64;
$answers[$i++] = $result->answer_65;
$answers[$i++] = $result->answer_66;
$answers[$i++] = $result->answer_67;
$answers[$i++] = $result->answer_68;
$answers[$i++] = $result->answer_69;
$answers[$i++] = $result->answer_70;
$answers[$i++] = $result->answer_71;
$answers[$i++] = $result->answer_72;
$answers[$i++] = $result->answer_73;
$answers[$i++] = $result->answer_74;
$answers[$i++] = $result->answer_75;
$answers[$i++] = $result->answer_76;
$answers[$i++] = $result->answer_77;
									...
									echo '<div class="single-question">';
										...
										echo '<div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_giaotiep['.$count.']" id="atec_giaotiep'.$count.'1" class="tab_quest0 name_radio'.$i.'" value="1" '.gen_atec_checkbox($answers[$index], "1") .'/>
													<label for="atec_giaotiep'.$count.'1">Không đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_giaotiep['.$count.']" id="atec_giaotiep'.$count.'2" class="tab_quest0 name_radio'.$i.'" value="2" '.gen_atec_checkbox($answers[$index], "2") .'/>
													<label for="atec_giaotiep'.$count.'2">Khá/hơi đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_giaotiep['.$count.']" id="atec_giaotiep'.$count.'3" class="tab_quest0 name_radio'.$i.'" value="3" '.gen_atec_checkbox($answers[$index], "3") .'/>
							...
							foreach ($atec[1] as $atec_question) {
								echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
									...
									echo '<div class="single-question">';
										...
										echo '<div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_kynang['.$count.']" id="atec_kynang'.$count.'1" class="tab_quest1 name_radio'.$i.'" value="1" '.gen_atec_checkbox($answers[$index], "1") .'/>
													<label for="atec_kynang'.$count.'1">Không đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_kynang['.$count.']" id="atec_kynang'.$count.'2" class="tab_quest1 name_radio'.$i.'" value="2" '.gen_atec_checkbox($answers[$index], "2") .'/>
													<label for="atec_kynang'.$count.'2">Khá/hơi đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_kynang['.$count.']" id="atec_kynang'.$count.'3" class="tab_quest1 name_radio'.$i.'" value="3" '.gen_atec_checkbox($answers[$index], "3") .'/>
							...
							foreach ($atec[2] as $atec_question) {
								echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
									...
									echo '<div class="single-question">';
										...
										echo '<div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_nhanthuc['.$count.']" id="atec_nhanthuc'.$count.'1" class="tab_quest2 name_radio'.$i.'" value="1" '.gen_atec_checkbox($answers[$index], "1") .'/>
													<label for="atec_nhanthuc'.$count.'1">Không đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_nhanthuc['.$count.']" id="atec_nhanthuc'.$count.'2" class="tab_quest2 name_radio'.$i.'" value="2" '.gen_atec_checkbox($answers[$index], "2") .'/>
													<label for="atec_nhanthuc'.$count.'2">Khá/hơi đúng</label>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 33.33%;">
													<input type="radio" name="atec_nhanthuc['.$count.']" id="atec_nhanthuc'.$count.'3" class="tab_quest2 name_radio'.$i.'" value="3" '.gen_atec_checkbox($answers[$index], "3") .'/>
									...
									echo '<div class="single-question">';
										...
										echo '<div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 24%;">
													<input type="radio" name="atec_suckhoe['.$count.']" id="atec_suckhoe'.$count.'1" class="tab_quest2 name_radio'.$i.'" value="1" '.gen_atec_checkbox($answers[$index], "1") .'/>
													<b for="atec_suckhoe'.$count.'1">Không phải là vấn đề ở trẻ</b>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 24%;">
													<input type="radio" name="atec_suckhoe['.$count.']" id="atec_suckhoe'.$count.'2" class="tab_quest2 name_radio'.$i.'" value="2" '.gen_atec_checkbox($answers[$index], "2") .'/>
													<b for="atec_suckhoe'.$count.'2">Vấn đề nhỏ ở trẻ</b>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 26%;">
													<input type="radio" name="atec_suckhoe['.$count.']" id="atec_suckhoe'.$count.'3" class="tab_quest2 name_radio'.$i.'" value="3" '.gen_atec_checkbox($answers[$index], "3") .'/>
													<b for="atec_suckhoe'.$count.'3">Vấn đề trung bình ở trẻ (cần quan tâm)</b>
												</div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 26%;">
													<input type="radio" name="atec_suckhoe['.$count.']" id="atec_suckhoe'.$count.'4" class="tab_quest2 name_radio'.$i.'" value="4" '.gen_atec_checkbox($answers[$index], "4") .'/>
