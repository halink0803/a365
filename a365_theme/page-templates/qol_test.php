...
<div id="siteContent">
	...
	<div class="container">
		<img width="100%" src="<?php echo get_template_directory_uri().'/images/banner_qol.jpg'?>" title="qol-banner">
	    ...
	    <p>Vui lòng chọn phương án trả lời phản ánh đúng nhất cảm nhận của anh/chị trong <strong>4 tuần qua</strong></p>
									...
									echo '<div class="single-question">';
										...
										echo '<div>
												<div class="divCell" style="margin-top: 10px; float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'1" class="tab_quest0 name_radio'.$count.'" value="1" />
													<label for="qol_question'.$count.'1">Không hề</label>
												</div>
												<div class="divCell" style="margin-top: 10px;float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'2" class="tab_quest0 name_radio'.$count.'" value="2" />
													<label for="qol_question'.$count.'2">Một chút</label>
												</div>
												<div class="divCell" style="margin-top: 10px;float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'3" class="tab_quest0 name_radio'.$count.'" value="3" />
													<label for="qol_question'.$count.'3">Tương đối</label>
												</div>
												<div class="divCell" style="margin-top: 10px;float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'4" class="tab_quest0 name_radio'.$count.'" value="4" />
													<label for="qol_question'.$count.'4">Khá nhiều</label>
												</div>
												<div class="divCell" style="margin-top: 10px;float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'5" class="tab_quest0 name_radio'.$count.'" value="5" />
													<label for="qol_question'.$count.'5">Rất nhiều</label>
												</div>
												<div class="divCell" style="margin-top: 10px;float: left; width: 16.66%;">
													<input type="radio" name="qol_question['.$count.']" id="qol_question'.$count.'6" class="tab_quest0 name_radio'.$count.'" value="6" />
