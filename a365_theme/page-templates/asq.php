...
if ( ! defined( 'ABSPATH' ) ) exit;
  ...
  first_create_asq_result_in_db();

?>

<div class="exit_test">
    <a onclick="save_all_click_out('asq')" >
        <img src="<?php echo get_template_directory_uri().'/images/btn_exit.png' ?>" alt="" />
    </a>
</div>
<!-- ASQ Modal -->
      ...
      <div class="tab-content">
        <div class="question" id="box-paing">
                ...
                echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
                  echo '<div class="single-question">';
                    ...
                    echo '<div class="question-answer">
                            <div class="radio">
                                <label>
                                  <input id="giao_tiep'.$count.'1" name="giao_tiep['.$count.']" type="radio" value="10" class="tab_quest0"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="giao_tiep'.$count.'2" name="giao_tiep['.$count.']" type="radio" value="5" class="tab_quest0"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="giao_tiep'.$count.'3" name="giao_tiep['.$count.']" type="radio" value="0" class="tab_quest0"/>
                                <span class="label-text" for="giao_tiep'.$count.'3">
                                    CHƯA
                                </span>
                              </label>
                            </div>
                            <input checked="checked" name="giao_tiep['.$count.']" style="display:none;" type="radio" value="99"/>
                          </div>';
                  echo '</div>';
                echo '</div>';
                $count++;
                ...
                echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
                  echo '<div class="single-question">';
                    ...
                    echo '<div class="question-answer">
                            <div class="radio">
                                <label>
                                  <input id="van_dong_tho'.$count.'1" name="van_dong_tho['.$count.']" type="radio" value="10" class="tab_quest1"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="van_dong_tho'.$count.'2" name="van_dong_tho['.$count.']" type="radio" value="5" class="tab_quest1"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="van_dong_tho'.$count.'3" name="van_dong_tho['.$count.']" type="radio" value="0" class="tab_quest1"/>
                                <span class="label-text" for="van_dong_tho'.$count.'3">
                                    CHƯA
                                </span>
                              </label>
                            </div>
                            <input name="van_dong_tho['.$count.']" style="display:none;" type="radio" value="99" checked="checked"/>
                          </div>';
                  echo '</div>';
                echo '</div>';
                $count++;
                ...
                echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
                  echo '<div class="single-question">';
                    ...
                    echo '<div class="question-answer">
                            <div class="radio">
                                <label>
                                  <input id="van_dong_tinh'.$count.'1" name="van_dong_tinh['.$count.']" type="radio" value="10" class="tab_quest2"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="van_dong_tinh'.$count.'2" name="van_dong_tinh['.$count.']" type="radio" value="5" class="tab_quest2"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="van_dong_tinh'.$count.'3" name="van_dong_tinh['.$count.']" type="radio" value="0" class="tab_quest2"/>
                                <span class="label-text" for="van_dong_tinh'.$count.'3">
                                    CHƯA
                                </span>
                              </label>
                            </div>
                            <input name="van_dong_tinh['.$count.']" style="display:none;" type="radio" value="99" checked="checked"/>
                          </div>';
                  echo '</div>';
                echo '</div>';
                $count++;
                ...
                echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
                  echo '<div class="single-question">';
                    ...
                    echo '<div class="question-answer">
                            <div class="radio">
                                <label>
                                  <input id="giai_quyet'.$count.'1" name="giai_quyet['.$count.']" type="radio" value="10" class="tab_quest3" />
                            ...
                            <div class="radio"">
                              <label>
                                <input id="giai_quyet'.$count.'2" name="giai_quyet['.$count.']" type="radio" value="5" class="tab_quest3"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="giai_quyet'.$count.'3" name="giai_quyet['.$count.']" type="radio" value="0" class="tab_quest3"/>
                                <span class="label-text" for="giai_quyet'.$count.'3">
                                    CHƯA
                                </span>
                              </label>
                            </div>
                            <input name="giai_quyet['.$count.']" style="display:none;" type="radio" value="99" checked="checked"/>
                          </div>';
                  echo '</div>';
                echo '</div>';
                $count++;
                ...
                echo '<div class="tab-pane paging_list" id="paging_list'. $i .'">';
                  echo '<div class="single-question">';
                    ...
                    echo '<div class="question-answer">
                            <div class="radio">
                                <label>
                                  <input id="ca_nhan'.$count.'1" name="ca_nhan['.$count.']" type="radio" value="10" class="tab_quest4" />
                            ...
                            <div class="radio"">
                              <label>
                                <input id="ca_nhan'.$count.'2" name="ca_nhan['.$count.']" type="radio" value="5" class="tab_quest4"/>
                            ...
                            <div class="radio"">
                              <label>
                                <input id="ca_nhan'.$count.'3" name="ca_nhan['.$count.']" type="radio" value="0" class="tab_quest4"/>
                                <span class="label-text" for="ca_nhan'.$count.'3">
                                    CHƯA
                                </span>
                              </label>
                            </div>
                            <input name="ca_nhan['.$count.']" style="display:none;" type="radio" value="99" checked="checked"/>
                          </div>';
                  echo '</div>';
                echo '</div>';
                $count++;
                    ...
                    <div class="chooseAnswer box_dt pt10">
                        ...
                        <div class="answer pt10">
                            <div class="input4Survey">
                                <input class="tab_quest5 radio_check" id="tong_ket'.$count.'1" name="tong_ket['.$count.']" onclick="" type="radio" value="Có" >
                            ...
                            <div class="input4Survey">
                                <input class="tab_quest5 radio_check" id="tong_ket'.$count.'2" name="tong_ket['.$count.']" onclick="" type="radio" value="Không">
                                    <label class="color_red" for="tong_ket'.$count.'2">
                                        KHÔNG
                                    </label>
                                </input>
                            </div>
                            <input id="tong_ket'.$count.'3" name="tong_ket['.$count.']" onclick="" type="radio" value="Bỏ trống" style="display:none;" checked="checked">
                            </input>
                        </div>
                        ';
                        ...
                        <div class="textAreaSurvey">
                            <div class="input textarea">
                                <textarea class="radio_check" cols="30" id="tong_ket'.$count.'text" name="tong_ket_text['.$count.']" rows="6" style="width:100%"></textarea>
                            </div>
                        </div>
                        ';
                    echo '
          ...
          <div class="tab-footer">
              <p>Ages & Stages Questionnaires ® : A Parent-Completed Child Monitoring System, Third Edition (ASQ-3™), Squires & Bricker. © 2009 and Vietnamese translation (pilot version 3.4) © 2014 Paul H. Brookes Publishing Co., Inc. All rights reserved. With permission of the publisher.</p>
              <p>Bảng hỏi về Độ tuổi và Giai đoạn phát triển của trẻ ®, Ấn bản lần thứ ba (ASQ-3™), Tác giả: Squires & Bricker. © 2009
Bản quyền đã đăng ký và bản dịch tiếng Việt © 2014 của NXB Brookes với sự cho phép sử dụng của NXB Brookes.</p>
          </div>
        </div>
      </div>
    </div>
